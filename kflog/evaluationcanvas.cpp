...
EvaluationCanvas::EvaluationCanvas(QScrollView* parent, EvaluationDialog* dialog)
    : QCanvasView(parent, "EvaluationCanvas", false),
    startTime(0), secWidth(5), scrollFrame(parent), evalDialog(dialog)
{

  canvas = new QCanvas(600,300);
...
EvaluationCanvas::~EvaluationCanvas()
{}


QSize EvaluationCanvas::sizeHint()
{
...
QPoint EvaluationCanvas::__baroPoint(int durch[], int gn, int i)
{
...
QPoint EvaluationCanvas::__speedPoint(float durch[], int gn, int i)
{
  //  int x = ( curTime - startTime ) / secWidth + X_ABSTAND ;
...
QPoint EvaluationCanvas::__varioPoint(float durch[], int gn, int i)
{
  //  int x = ( curTime - startTime ) / secWidth + X_ABSTAND ;
...
void EvaluationCanvas::drawCurve(
  bool arg_vario, bool arg_speed,
...
void EvaluationCanvas::__paintCursor(int xpos, int calt, int move, int cursor)
{
...
void EvaluationCanvas::resizeEvent(QResizeEvent* event)
{
  ...
  //void EvaluationCanvas::drawPointer(const flightPoint * p){
  ...
  //void EvaluationCanvas::removePointer(bool forceRedraw) {
...
void EvaluationCanvas::preparePointer()
{
...
bool EvaluationCanvas::isShowingPointer()
{
...
void EvaluationCanvas::slotShowPointer(const flightPoint * fp){
  //  if (!fp) {
  //    removePointer(true);
  //  } else {
  //    drawPointer(fp);

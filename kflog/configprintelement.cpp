...
#define READ_BORDER(g, a) \
    group = g; \
    a[0] = _settings.readBoolEntry(group.append("/PrintBorder1"), true); \
    a[1] = _settings.readBoolEntry(group.append("/PrintBorder2"), true);

#define READ_PEN(g, a, b, C1, C2, P1, P2, S1, S2) \
  READ_BORDER(g, a) \
  b.append(new QPen(__string2Color(_settings.readEntry("/"+group.append("/PrintColor1"), __color2String(C1))), \
        _settings.readNumEntry("/"+group.append("/PrintPenSize1"), P1), \
        (Qt::PenStyle)_settings.readNumEntry(group.append("/PrintPenStyle1"), S1))); \
  b.append(new QPen(__string2Color(_settings.readEntry("/"+group.append("/PrintColor2"), __color2String(C2))), \
        _settings.readNumEntry("/"+group.append("/PrintPenSize2"), P2), \
        (Qt::PenStyle)_settings.readNumEntry(group.append("/PrintPenStyle2"), S2)));

#define READ_PEN_BRUSH(g, a, b, c, C1, C2, P1, P2, S1, S2, CB1, CB2, SB1, SB2) \
  READ_PEN(g, a, b, C1, C2, P1, P2, S1, S2) \
  c.append(new QBrush(__string2Color(_settings.readEntry("/"+group.append("/PrintBrushColor1"), __color2String(CB1))), \
        (Qt::BrushStyle)_settings.readNumEntry("/"+group.append("/PrintBrushStyle1"), SB1))); \
  c.append(new QBrush(__string2Color(_settings.readEntry("/"+group.append("/PrintBrushColor2"), __color2String(CB2))), \
        (Qt::BrushStyle)_settings.readNumEntry("/"+group.append("/PrintBrushStyle2"), SB2)));

#define WRITE_PEN(g,a,b) \
    group = g; \
    _settings.writeEntry("/"+group.append("/PrintColor1"), __color2String(a.at(0)->color())); \
    _settings.writeEntry("/"+group.append("/PrintColor2"), __color2String(a.at(1)->color())); \
    _settings.writeEntry("/"+group.append("/PrintPenSize1"), (int)a.at(0)->width()); \
    _settings.writeEntry("/"+group.append("/PrintPenSize2"), (int)a.at(1)->width()); \
    _settings.writeEntry("/"+group.append("/PrintPenStyle1"), a.at(0)->style()); \
    _settings.writeEntry("/"+group.append("/PrintPenStyle2"), a.at(1)->style()); \
    _settings.writeEntry("/"+group.append("/PrintBorder1"), b[0]); \
    _settings.writeEntry("/"+group.append("/PrintBorder2"), ( b[1] && b[0] ) );

#define WRITE_BRUSH(g,a,b,c) \
    WRITE_PEN(g,b,c) \
    _settings.writeEntry("/"+group.append("/PrintBrushColor1"), __color2String(a.at(0)->color())); \
    _settings.writeEntry("/"+group.append("/PrintBrushColor2"), __color2String(a.at(1)->color())); \
    _settings.writeEntry("/"+group.append("/PrintBrushStyle1"), a.at(0)->style()); \
    _settings.writeEntry("/"+group.append("/PrintBrushStyle2"), a.at(1)->style());
...
ConfigPrintElement::ConfigPrintElement(QWidget* parent)
  : QFrame(parent, "ConfigPrintelement"), oldElement(-1)
{
  ...
  READ_PEN_BRUSH("City", cityBorder, cityPenList, cityBrushList,
        PRINT_CITY_COLOR_1, PRINT_CITY_COLOR_2,
        PRINT_CITY_PEN_1, PRINT_CITY_PEN_2,
        PRINT_CITY_PEN_STYLE_1, PRINT_CITY_PEN_STYLE_2,
        PRINT_CITY_BRUSH_COLOR_1, PRINT_CITY_BRUSH_COLOR_2,
        PRINT_CITY_BRUSH_STYLE_1, PRINT_CITY_BRUSH_STYLE_2)

  READ_PEN_BRUSH("RiverT", river_tBorder, river_tPenList, river_tBrushList,
  ...
  READ_PEN_BRUSH("Forest", forestBorder, forestPenList, forestBrushList,
  ...
  READ_PEN_BRUSH("Glacier", glacierBorder, glacierPenList, glacierBrushList,
  ...
  READ_PEN_BRUSH("PackIce",  packiceBorder, packicePenList,packiceBrushList,
  ...
  READ_PEN_BRUSH("AirspaceA", airABorder, airAPenList, airABrushList,
  ...
  READ_PEN_BRUSH("AirspaceB",  airBBorder, airBPenList,airBBrushList,
  ...
  READ_PEN_BRUSH("AirspaceC", airCBorder, airCPenList, airCBrushList,
  ...
  READ_PEN_BRUSH("AirspaceD", airDBorder, airDPenList, airDBrushList,
  ...
  READ_PEN_BRUSH("AirspaceELow", airElBorder, airElPenList, airElBrushList,
  ...
  READ_PEN_BRUSH("AirspaceEHigh", airEhBorder, airEhPenList, airEhBrushList,
  ...
  READ_PEN_BRUSH("AirspaceF", airFBorder, airFPenList, airFBrushList,
  ...
  READ_PEN_BRUSH("ControlC", ctrCBorder, ctrCPenList, ctrCBrushList,
  ...
  READ_PEN_BRUSH("ControlD", ctrDBorder, ctrDPenList, ctrDBrushList,
  ...
  READ_PEN_BRUSH("Danger", dangerBorder, dangerPenList, dangerBrushList,
  ...
  READ_PEN_BRUSH("LowFlight", lowFBorder, lowFPenList, lowFBrushList,
  ...
  READ_PEN_BRUSH("RestrictedArea", restrBorder, restrPenList, restrBrushList,
  ...
  READ_PEN_BRUSH("TMZ",  tmzBorder, tmzPenList,tmzBrushList,
  ...
  READ_PEN_BRUSH("FAIAreaLow500", faiAreaLow500Border, faiAreaLow500PenList, faiAreaLow500BrushList,
  ...
  READ_PEN_BRUSH("FAIAreaHigh500", faiAreaHigh500Border, faiAreaHigh500PenList, faiAreaHigh500BrushList,

...
public:
	...
	public:
		...
		float lat;    // latitude in degrees, southern values are negative
		float lon;    // longitude in degrees, western values are negative
...
public:
	...
	// Initialize the API
	VLA_ERROR open(
		boolean connect = 0, // if connect = 1, a connection to the logger will be established
	...
	void close(
		boolean reset=0 // reset=1 will cause the logger to leave data mode and restart
	);
};

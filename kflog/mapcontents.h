...
/////////////////////////////////////////////////////////////
//  Isohypse* getIsohypse(unsigned int id);
/////////////////////////////////////////////////////////////
 ...
 private:
  ...
  /** reads an ascii-file containing elevation-data. */
//  bool __readAsciiIsoFile(const char* fileName);
  /** */
  ...
  /**
    ...
    */
//  QList<Isohypse> isohypseList;          // <- für die 0m Ebene
  QList< QList<Isohypse> > isoList;   // <- für den Rest
  /**
